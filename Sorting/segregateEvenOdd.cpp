// segregate even to left and odd to right 
#include<bits/stdc++.h>
using namespace std;
...
void segregateEvenOdd(ll *nums,ll n);
...
void segregateEvenOdd(ll *nums,ll n){
    // ? order of even numbers on the left does not matter and same for the odd numbers 
    // !T(N) = O(N)
    // !S(N) = O(1)
