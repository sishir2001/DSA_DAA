// segregate negative to left and positive to right 
#include<bits/stdc++.h>
using namespace std;
...
void segregateNegPos(ll *nums,ll n);
...
void segregateNegPos(ll *nums,ll n){
    // ? order of negative numbers on the left does not matter and same for the positive numbers 
    // !T(N) = O(N)
    // !S(N) = O(1)
